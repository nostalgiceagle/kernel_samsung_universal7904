...
static int gpex_clock_update_config_data_from_dt(void)
{
	...
	clk_info.gpu_max_clock = 1300000; // gpexbe_devicetree_get_int(gpu_max_clock);
	clk_info.gpu_min_clock = 1001000; // gpexbe_devicetree_get_int(gpu_min_clock);
	clk_info.boot_clock = 1300000; // gpexbe_clock_get_boot_freq();
	clk_info.gpu_max_clock_limit = 1300000; // gpexbe_clock_get_max_freq();
